...
myCmd1 = 'omxplayer -o alsa auden1.mp3' # These examples are from the "Auden bot"
myCmd2 = 'omxplayer -o alsa auden2.mp3' # Change 
myCmd3 = 'omxplayer -o alsa auden3.mp3' # as
myCmd4 = 'omxplayer -o alsa auden4.mp3' # needed
