...
myCmd1 = 'omxplayer --vol 602 -o alsa ~/historybots/bots/ali_bot/ali1.mp3' # this clip was too low, changed volume
myCmd2 = 'omxplayer -o alsa ~/historybots/bots/ali_bot/ali2.mp3' # These examples are from the "Ali bot"
myCmd3 = 'omxplayer -o alsa ~/historybots/bots/ali_bot/ali3.mp3' # change
myCmd4 = 'omxplayer -o alsa ~/historybots/bots/ali_bot/ali4.mp3' # as
myCmd5 = 'omxplayer -o alsa ~/historybots/bots/ali_bot/ali5.mp3' # needed
myCmd6 = 'omxplayer -o alsa ~/historybots/bots/ali_bot/ali6.mp3'
